...
UI_LABELS = {
    ...
    "legal_disclaimer": {
        ...
        "bn":  "এটি সরকারি সরকারি রেকর্ডের উপর ভিত্তি করে একটি বিশ্লেষণমূলক প্রতিবেদন। এটি কোনো আইনি রায় নয়।",
        "gu":  "આ સત્તાવાર જાહેર રેકર્ડ પર આધારિત વિશ્લેષણ અહેવાલ છે. આ કોઈ કાનૂની તારણ નથી.",
        "pa":  "ਇਹ ਸਰਕਾਰੀ ਜਨਤਕ ਰਿਕਾਰਡਾਂ 'ਤੇ ਅਧਾਰਿਤ ਵਿਸ਼ਲੇਸ਼ਣਾਤਮਕ ਰਿਪੋਰਟ ਹੈ। ਇਹ ਕੋਈ ਕਾਨੂੰਨੀ ਫੈਸਲਾ ਨਹੀਂ ਹੈ।",
        "ur":  "یہ سرکاری عوامی ریکارڈ پر مبنی تجزیاتی رپورٹ ہے۔ یہ قانونی فیصلہ نہیں ہے۔",
        "or":  "ଏହା ଅଧିକୃତ ସର୍ବସାଧାରଣ ରେକର୍ଡ ଉପରେ ଆଧାରିତ ଏକ ବିଶ୍ଳେଷଣ ରିପୋର୍ଟ। ଏହା ଆଇନଗତ ନିଷ୍ପତ୍ତି ନୁହେଁ।",
    },
    "investigation_title": {
        "en": "Investigation Results",
        "hi": "जांच परिणाम",
        "ta": "விசாரணை முடிவுகள்",
        "te": "దర్యాప్తు ఫలితాలు",
        "kn": "ತನಿಖೆ ಫಲಿತಾಂಶಗಳು",
        "ml": "അന്വേഷണ ഫലങ്ങൾ",
        "mr": "तपास निकाल",
        "bn": "তদন্ত ফলাফল",
    ...
    "no_results": {
        "en": "No results found. Try a different name or check spelling.",
        "hi": "कोई परिणाम नहीं मिला। कोई अलग नाम आज़माएं।",
        "ta": "முடிவுகள் இல்லை. வேறு பெயரை முயற்சிக்கவும்.",
        "te": "ఫలితాలు కనుగొనబడలేదు. వేరే పేరు ప్రయత్నించండి.",
        "kn": "ಫಲಿತಾಂಶಗಳು ಕಂಡುಬಂದಿಲ್ಲ. ಬೇರೆ ಹೆಸರನ್ನು ಪ್ರಯತ್ನಿಸಿ.",
        "ml": "ഫലങ്ങൾ കണ്ടെത്തിയില്ല. മറ്റൊരു പേര് ശ്രമിക്കൂ.",
        "mr": "कोणतेही परिणाम सापडले नाहीत. वेगळे नाव वापरून पहा.",
        "bn": "কোনো ফলাফল পাওয়া যায়নি। অন্য নাম চেষ্টা করুন।",
        "gu": "કોઈ પરિણામ મળ્યાં નથી. બીજું નામ અજમાવો.",
        "pa": "ਕੋਈ ਨਤੀਜੇ ਨਹੀਂ ਮਿਲੇ। ਕੋਈ ਹੋਰ ਨਾਮ ਅਜ਼ਮਾਓ।",
    },
    "tagline": {
        ...
        "kn": "ಸಾರ್ವಜನಿಕ ಪಾರದರ್ಶಕತೆ ಬುದ್ಧಿಮತ್ತೆ ವೇದಿಕೆ",
        "ml": "പൊതു സുതാര്യ ഇന്റലിജൻസ് പ്ലാറ്റ്ഫോം",
        "mr": "सार्वजनिक पारदर्शकता बुद्धिमत्ता व्यासपीठ",
        "bn": "পাবলিক স্বচ্ছতা ইন্টেলিজেন্স প্ল্যাটফর্ম",
        "gu": "જાહેર પારદર્શિતા ગુપ્તચર મંચ",
        "pa": "ਜਨਤਕ ਪਾਰਦਰਸ਼ਤਾ ਇੰਟੈਲੀਜੈਂਸ ਪਲੇਟਫਾਰਮ",
        "ur": "عوامی شفافیت انٹیلیجنس پلیٹ فارم",
    },
}
